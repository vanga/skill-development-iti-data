...
with open('response.ndjson', 'w') as file:
    while has_more_data:
        payload = {
            "version": "1.0.0",
            "queries": [
                                ...
                                "SemanticQueryDataShapeCommand": {
                                    ...
                                    "Binding": {
                                        ...
                                        "DataReduction": {
                                            "DataVolume": 3,
                                            "Primary": {
                                                "Window": {"Count": batch_size, "Page": page_number}
                                            }
                                        },
                                        "Version": 1
                                    },
        ...
        try:
            ...
            print(f"Page {page_number} Response:", response.json())
            data = response.json()
            rows = data.get('S', [])
            ...
            last_pkTraineeRegNumber = rows[-1]['N'] if rows else None
